...
from src.models.models import ChatContent, ContentItem, CourseSection, CourseStructure
...
class SessionEvent:
    ...
    def __init__(
        self, event_type: SessionEventType, session_id: str, data: Dict[str, Any]
    ):
...
class IMoodleClient(ABC):
    ...
    async def create_section(
        self, course_id: int, name: str, description: str, position: int
    ) -> int:
...
class IContentProcessor(ABC):
    ...
    async def process_content_chunk(
        self, session_id: str, chunk_index: int, continue_previous: bool = False
...
class IServiceContainer(ABC):
    ...
    @abstractmethod
    def register(
        self, interface_type: type, implementation: Any, singleton: bool = True
    ) -> None:
