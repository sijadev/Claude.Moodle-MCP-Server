...
class MoodleConfig:
    ...
    def to_env_format(self) -> Dict[str, str]:
        ...
        return {
            ...
            "MOODLE_CLAUDE_DETAILED_PROGRESS": str(
                self.server.detailed_progress
            ).lower(),
            # Meta
    ...
    def generate_env_file(self, filepath: str):
        ...
        with open(filepath, "w") as f:
            ...
            f.write(
                f"MOODLE_CLAUDE_USE_EMOJIS={env_vars['MOODLE_CLAUDE_USE_EMOJIS']}\n"
            )
            f.write(
                f"MOODLE_CLAUDE_DETAILED_PROGRESS={env_vars['MOODLE_CLAUDE_DETAILED_PROGRESS']}\n\n"
            )
    ...
    def get_claude_desktop_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "env": {
                ...
                "MOODLE_CLAUDE_DETAILED_PROGRESS": env_vars[
                    "MOODLE_CLAUDE_DETAILED_PROGRESS"
                ],
            },
        }
...
def get_master_config() -> MoodleConfig:
    ...
    if _master_config is None:
        config_file = (
            "/Users/simonjanke/Projects/MoodleClaude/config/master_config.json"
        )
