...
async def test_exact_validation():
    ...
    async with plugin_client as client:
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_create_course_structure', test_data)
        ...
        try:
            ...
            test_data = {
                'courseId': course_id,  # Different case
                'sections': []
            }
            print(f"Sending: {json.dumps(test_data, indent=2)}")
            result = await client._call_api('local_moodleclaude_create_course_structure', test_data)
        ...
        try:
            ...
            section_result = await client._call_api('local_moodleclaude_update_section_content', {
                'courseid': course_id,
                'section': 1,
