...
async def test_individual_functions():
    ...
    async with plugin_client as client:
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_update_section_content', {
                'courseid': course_id,
        ...
        try:
            result = await client._call_api('local_moodleclaude_create_page_activity', {
                'courseid': course_id,
                'section': 1,
                'name': 'Test Page',
        ...
        try:
            result = await client._call_api('local_moodleclaude_create_label_activity', {
                'courseid': course_id,
                'section': 1,
        ...
        try:
            result = await client._call_api('local_moodleclaude_create_file_resource', {
                'courseid': course_id,
                'section': 1,
                'name': 'Test File',
                'filename': 'test.txt',
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_create_course_structure', minimal_data)
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_create_course_structure', single_section_data)
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_create_course_structure', wrong_type_data)
        ...
        try:
            ...
            result = await client._call_api('local_moodleclaude_create_course_structure', invalid_course_data)
