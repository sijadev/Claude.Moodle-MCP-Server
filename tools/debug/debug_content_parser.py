...
def test_content_parser():
    ...
    if parsed.items:
        ...
        print(f"  Code block pattern: {parser.code_block_pattern.pattern if parser.code_block_pattern else 'None'}")
        ...
        if parser.code_block_pattern:
            ...
            for match in matches:
                ...
                print(f"    - Code preview: {match[1][:50]}..." if match and len(match) > 1 else "    - No code")
