        ...
        try:
            ...
            if 'functions' in site_info:
                ...
                for func in functions:
                    ...
                    if any(keyword in func_name for keyword in ['create', 'add', 'mod_', 'activity', 'resource', 'page', 'label', 'file']):
                    ...
                    if any(f.get('name') == func_name for f in functions):
                        ...
                        try:
                            ...
                            if 'page' in func_name:
                                result = await client._call_api(func_name, {
                                    'course': course_id,
...
async def test_alternative_approaches():
    ...
    async with MoodleClient(config.moodle_url, config.moodle_token) as client:
        ...
        try:
            ...
            forums = await client._call_api("mod_forum_get_forums_by_courses", {
            ...
            if forums:
                ...
                result = await client._call_api("mod_forum_add_discussion", {
                    "forumid": forum_id,
        ...
        try:
            ...
            result = await client._call_api("core_course_update_courses", {
