...
async def test_wsmanage_parameters():
    ...
    async with MoodleClient(moodle_url, moodle_token) as client:
        ...
        for test_format in test_formats:
            ...
            try:
                result = await client._call_api("local_wsmanagesections_create_sections", test_format['params'])
        ...
        try:
            ...
            result = await client._call_api("local_wsmanagesections_create_sections", minimal_params)
