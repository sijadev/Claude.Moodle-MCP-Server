...
async def test_correct_wsmanage():
    ...
    async with MoodleClient(moodle_url, moodle_token) as client:
        ...
        print(f"\n📖 Initial sections:")
        initial_sections = await client._call_api(
        ...
        try:
            ...
            # Verify
            final_sections = await client._call_api(
                "local_wsmanagesections_get_sections", {"courseid": course_id}
            )
        ...
        try:
            ...
            sections_to_check = await client._call_api(
                "local_wsmanagesections_get_sections", {"courseid": course_id}
            )
        ...
        final_structure = await client._call_api(
            "local_wsmanagesections_get_sections", {"courseid": course_id}
        )
