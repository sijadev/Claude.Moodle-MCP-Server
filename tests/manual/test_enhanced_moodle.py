        ...
        async with MoodleClient(moodle_url, moodle_token) as client:
            ...
            content_items = [
                (
                    ...
                    "Learn about Python variables, strings, numbers, and booleans",
                ),
                (
                    "Control Structures",
                    "Understanding if statements, loops, and conditional logic",
                ),
            ...
            for title, description in content_items:
                ...
                if "Exercise" in title:
                    ...
                    keyword in title for keyword in ["Object-Oriented", "Advanced"]
                ):
            ...
            print(
                f"🔗 View course: http://localhost:8080/course/view.php?id={course_id}"
            )
