...
async def test_wsmanagesections_plugin():
    ...
    try:
        async with MoodleClient(moodle_url, moodle_token) as client:
            ...
            try:
                wms_sections = await client._call_api("local_wsmanagesections_get_sections", {
                    "courseid": course_id
                })
            ...
            try:
                ...
                create_result = await client._call_api("local_wsmanagesections_create_sections", new_section_data)
            ...
            try:
                ...
                alt_result = await client._call_api("local_wsmanagesections_create_sections", alt_params)
            ...
            try:
                ...
                update_result = await client._call_api("local_wsmanagesections_update_sections", update_params)
