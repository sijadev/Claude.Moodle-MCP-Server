...
from src.core.interfaces import (
    ISessionRepository, IEventPublisher, ISessionObserver, ISessionCommand,
    ICourseCreationService, SessionEvent, SessionEventType, CommandResult
)
from src.core.event_system import EventPublisher, MetricsObserver, LoggingObserver
from src.core.repositories import InMemorySessionRepository, SQLiteSessionRepository
from src.core.command_system import (
    BaseCommand, CommandExecutor, CreateCourseCommand, CommandContext, CommandStatus
)
...
class TestObserverPattern:
    ...
    async def test_metrics_observer(self):
        ...
        events = [
            ...
            SessionEvent(SessionEventType.SESSION_COMPLETED, "session_1", {"processing_time": 5.5}),
...
class TestRepositoryPattern:
    ...
    async def test_repository_get_active_sessions(self):
        ...
        sessions = [
            ...
            {"session_id": "session_2", "course_name": "Course 2", "state": "processing"},
            {"session_id": "session_3", "course_name": "Course 3", "state": "completed"}
        ]
...
class TestServiceLayer:
    ...
    async def test_service_dependency_injection(self):
        ...
        # Setup mocks
        self.mock_content_processor.analyze_content_complexity = AsyncMock(return_value={
...
class TestIntegratedArchitecture:
    ...
    async def test_full_dependency_injection_workflow(self):
        ...
        # Register services
        container.register(ISessionRepository, InMemorySessionRepository, ServiceLifetime.SINGLETON)
